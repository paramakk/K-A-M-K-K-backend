...
public class CardController extends CrudController<Long, CardDTO> {
  ...
  public ResponseEntity<List<CardDTO>> findAllByUserName(
    @PathVariable String author
  ) {
    return new ResponseEntity<>(
      cardService.findAllByAuthorIs(author),
      HttpStatus.OK
    );
  }
  ...
  public ResponseEntity<List<CardDTO>> findAllByCardGroupId(
    @PathVariable Long id
  ) {
    return new ResponseEntity<>(
      cardService.findAllByCardGroupId(id),
      HttpStatus.OK
    );
  }
}
