...
public class ImageServiceImpl implements ImageService {
    ...
    public ImageDTO getById(Long id) {
        return modelMapper.map(imageRepository.findById(id).orElseThrow(EntityNotFoundException::new), ImageDTO.class);
    }

    @Override
    public ImageDTO create(ImageDTO entity) {
        return modelMapper.map(imageRepository.save(modelMapper.map(entity, Image.class)), ImageDTO.class);
    }
    ...
    public void delete(Long id) {
        imageRepository.delete(imageRepository.findById(id).orElseThrow(EntityNotFoundException::new));
